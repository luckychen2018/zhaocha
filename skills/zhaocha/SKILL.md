...
**Round 2 (Critique):** When user sends "挑刺" / "找茬" / "zhaocha" as the entire message:
...
Do NOT add "找茬? 挑刺" after critique. Wait for user's next real question.
...
- Only trigger critique on EXACT match of trigger words. "挑刺 what about X?" is a question, not a trigger.
- Critique targets the immediately previous answer only.
- If previous answer was already a critique, treat "挑刺" as a real question.
